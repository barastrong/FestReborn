document.addEventListener('DOMContentLoaded', () => {
        const hotels = [
            ...
            { 
                ...
                lokasi: "Jl. Jemursari No.118-120, Surabaya", 
                rating: 4.5, 
            ...
            { 
                ...
                lokasi: "Jl. Jemur Andayani No.67, Surabaya", 
                rating: 4.6, 
            ...
            { 
                ...
                lokasi: "Jl. Ngagel No.173-175, Surabaya", 
                rating: 4.7, 
            ...
            { 
                ...
                lokasi: "Jl. Mayjen Sungkono No.106, Surabaya", 
                rating: 4.9, 
            ...
            { 
                ...
                lokasi: "Jl. A. Yani No.288, Surabaya", 
                rating: 4.3, 
            ...
            { 
                ...
                lokasi: "Jl. Embong Malang No.85-89, Surabaya", 
                rating: 4.8, 
            ...
            { 
                ...
                lokasi: "Jl. Manyar Kertoarjo No.44, Surabaya", 
                rating: 4.4, 
            ...
            { 
                ...
                lokasi: "Jl. Embong Malang No.25-31, Sidoarjo", 
                rating: 4.7, 
            ...
            { 
                ...
                lokasi: "Jl. Mayjen Sungkono, Surabaya", 
                rating: 4.2, 
            ...
            { 
                ...
                lokasi: "Jl. Mayjen Sungkono No.16-18, Surabaya", 
                rating: 4.5, 
            ...
            { 
                ...
                lokasi: "Jl. Raya Gubeng No.54, Surabaya", 
                rating: 4.6, 
                        ...
                        <div class="p-6 md:w-3/5 flex flex-col justify-between">
                            <div>
                                <div class="flex items-start justify-between mb-3">
                                    <h3 class="text-xl font-bold text-slate-800 flex-1">${item.name}</h3>
                                </div>
